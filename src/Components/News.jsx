...
function News({onShowBlogs, blogs, onEditBlog, onDeleteBlog}) {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      let url = `https://gnews.io/api/v4/top-headlines?category=${selectedCategory}&lang=en&apikey=2fdafc85cbdbaff2992a4e0e9dfd9efd`;

      if(searchQuery) {
        url = `https://gnews.io/api/v4/search?q=${searchQuery}&lang=en&apikey=2fdafc85cbdbaff2992a4e0e9dfd9efd`
      }
  ...
  return (
    <div className="news">
      ...
      <footer className="news-footer">
        ...
        <p> All Rights Reserved &copy; {footerDate}</p>
      </footer>
    </div>
  );
}
